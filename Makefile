...
BuildingScape-Linux-Debug:
	 $(PROJECTBUILD) BuildingScape Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingScape-Linux-DebugGame:
	 $(PROJECTBUILD) BuildingScape Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingScape-Linux-Shipping:
	 $(PROJECTBUILD) BuildingScape Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingScape-Linux-Test:
	 $(PROJECTBUILD) BuildingScape Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingScape:
	 $(PROJECTBUILD) BuildingScape Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingScapeEditor-Linux-Debug:
	 $(PROJECTBUILD) BuildingScapeEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingScapeEditor-Linux-DebugGame:
	 $(PROJECTBUILD) BuildingScapeEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingScapeEditor-Linux-Shipping:
	 $(PROJECTBUILD) BuildingScapeEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingScapeEditor-Linux-Test:
	 $(PROJECTBUILD) BuildingScapeEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

BuildingScapeEditor:
	 $(PROJECTBUILD) BuildingScapeEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
