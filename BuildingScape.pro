...
unrealRootPath=/home/tecnologer/UnrealEngine
BuildingScapeRootPath=/home/tecnologer/Documents/Unreal Projects/BuildingScape

gameProjectFile=/home/tecnologer/Documents/Unreal Projects/BuildingScape/BuildingScape.uproject
...
include(BuildingScapeSource.pri)
include(BuildingScapeHeader.pri)
include(BuildingScapeConfig.pri)
include(BuildingScapeIncludes.pri)
include(BuildingScapeDefines.pri)

BuildingScape-Linux-Debug.commands = $$build BuildingScape Linux Debug  -project="\"$$gameProjectFile\"" $$args
BuildingScape-Linux-DebugGame.commands = $$build BuildingScape Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BuildingScape-Linux-Shipping.commands = $$build BuildingScape Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BuildingScape-Linux-Test.commands = $$build BuildingScape Linux Test  -project="\"$$gameProjectFile\"" $$args
BuildingScape.commands = $$build BuildingScape Linux Development  -project="\"$$gameProjectFile\"" $$args

BuildingScapeEditor-Linux-Debug.commands = $$build BuildingScapeEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
BuildingScapeEditor-Linux-DebugGame.commands = $$build BuildingScapeEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BuildingScapeEditor-Linux-Shipping.commands = $$build BuildingScapeEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BuildingScapeEditor-Linux-Test.commands = $$build BuildingScapeEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
BuildingScapeEditor.commands = $$build BuildingScapeEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	BuildingScape-Linux-Debug \
	BuildingScape-Linux-DebugGame \
	BuildingScape-Linux-Shipping \
	BuildingScape-Linux-Test \
	BuildingScape \
	BuildingScapeEditor-Linux-Debug \
	BuildingScapeEditor-Linux-DebugGame \
	BuildingScapeEditor-Linux-Shipping \
	BuildingScapeEditor-Linux-Test \
	BuildingScapeEditor \
